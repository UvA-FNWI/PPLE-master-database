...
export default class Overview extends Component<IProps, IState> {
  ...
  componentDidMount(): void {
    ...
    notification.open({
      ...
      description: (
        <div>
          <span>Welcome to AUC’s Master’s Database. Here you will find an interactive map of some of the master’s and PhD programmes AUC alumni have completed. This map is based on AUC’s 2023 graduate survey.</span>
          <br /><br />
